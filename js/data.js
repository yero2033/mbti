...
const infoList = [
  {
    ...
    desc: '혼자서도 알아서 잘 지내는 타입의 당신! 하지만, 관심이 아예 필요없는 것은 아니에요. 잘 지내는 것 같다고 눈에 담지 않으면 조금씩 상처받기도 한답니다. 알아차리기 쉽지 않아서 꾸준히 살펴봐야 알 수 있어요. 그렇다고 한꺼번에 관심을 퍼붓게 되면 과부하가 걸리고 말죠. 매일 부담스럽지 않은 시선과 관심을 준다면 어느날 예쁜 꽃을 피울거에요.'
  },
  {
  ...
  },
  {
    ...
    desc: '알아서 뭐든지 척척 스스로 잘하는 당신! 남에게 힘이 되어주는 의젓한 타입이랍니다. 그렇다고 너무 다 의지하게 되면 어느날 갑자기 지칠 수 있으니 틸란도 만능이 아님을 명심해야 해요. 고맙고 든든하다는 인정을 받을 때 큰 성장을 해요.'
  },
  {
    name: '화려하고 주목받는 것을 좋아하는 <수국>',
    desc: '화려한 것과 성과를 중시하는 당신! 호기심이 많고 여러 상황에서 자신과 재능을 나타내고 싶은 욕구가 많아요. 누구보다 화려하고 매력있지만, 남보다 앞서고 싶은 마음 때문에 가끔 놓치는 것이 생기곤 해요. 잠깐 멈추는 때를 아는 지혜를 배운다면 다음에도 화려한 꽃을 피울 수 있을 거에요.'
  },
  {
    name: '주변에 사람이 끊이지 않는 인기쟁이 <허브>',
    desc: '언제나 인기가 많은 당신! 남의 어려움을 빠르게 알아채고 배려하면서 행동하는 습관이 몸에 배어 있어요. 타인을 위하는 것은 세상에 선한 영향력을 가져다 주지요. 하지만, 보살핌을 제대로 받지 않으면 가장 약한 식물이기도 하답니다. 허브에게도 자신의 인생이 있음을 기억해야 하겠죠?'
  },
  {
